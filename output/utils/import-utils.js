 ...
 */
export function addSafeImport(sourceFile, importStatement) {
    ...
    const existing = sourceFile.getImportDeclarations().find(imp => imp.getModuleSpecifierValue() === moduleSpecifier);
    if (existing) {
